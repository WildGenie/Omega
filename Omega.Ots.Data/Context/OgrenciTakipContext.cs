namespace Omega.Ots.Data.Context
{
    ...
    public class OgrenciTakipContext : BaseDbContext<OgrenciTakipContext, Configuration>
    {
        ...
        {
            //Birbiriyle iliþkili tablolarda select sorgusu gönderdiðimizde iliþkilendirilen kayýtlarýn tamamýnýn gelmesini engelledik.
            //true olursa bütün bilgiler gelir.
            //Sorgularýmýzýn yavaþ çalýþmasýna sebep olur.
        ...
        {
            //Bu iþlem table isimlerini çoðullaþtýrýp, sonuna S ekler.
            modelBuilder.Conventions.Remove<PluralizingTableNameConvention>();

            //Bire çok iliþkili tablolarda ona baðlý verileri silmek için kullanýlýr.
