...
namespace Omega.Ots.UI.Win.Forms.BaseForms
{
    public partial class BaseListForm : RibbonForm
    {
        ...
        private void EventsLoad()
        {
            ...
            //Ada göre sıralı yaptıysak tekrar açtığımız da bu şekilde gelmesi için bu eventte yakalıyoruz.
        ...
        protected virtual void OtomatikKurKaydet() { }
        //*******************************************************************Eventler**************************************************************
        ...
        private void BaseListForm_Shown(object sender, EventArgs e)
        {
            ...
            ButonGizleGoster();
            SutunGizleGoster();
            //.HasValue özelliği gelen değerin null olup olmadığınıda kontrol eder.
        ...
        protected virtual void Button_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            else if (e.Item == btnOtomatikKurKaydet )
            {
                OtomatikKurKaydet();
            }
