        ...
        private void AlanIslemleri()
        {
            ...
            switch (MakbuzTuru)
            {
                ...
                case MakbuzTuru.BlokeCozumu:
                    //Enum içinde filtre uygulama işlemi yapılıyor.
                    //Makbuz Türü Blokeye alma veya Bloke Çözme Seçildiyse 
                    //HesapTürü Sadece bunlar olabilsin dedik. 
                    txtHesapTuru.Properties.Items.AddRange(Enum.GetValues(typeof(MakbuzHesapTuru))
                        .Cast<MakbuzHesapTuru>().Where(x => x == MakbuzHesapTuru.Epos || x == MakbuzHesapTuru.Ots || x == MakbuzHesapTuru.Pos)
                ...
                case MakbuzTuru.PorfoyeKarsiliksizIade:
                    txtHesapTuru.Properties.Items.AddRange(Enum.GetValues(typeof(MakbuzHesapTuru))
                        .Cast<MakbuzHesapTuru>().Where(x => x == MakbuzHesapTuru.Avukat || x == MakbuzHesapTuru.Banka || x == MakbuzHesapTuru.Cari)
                        .Select(x => x.ToName()).ToList());
                    break;
