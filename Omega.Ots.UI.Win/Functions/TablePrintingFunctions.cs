...
namespace Omega.Ots.UI.Win.Functions
{
    public class TablePrintingFunctions
    {
        ...
        public static void Yazdir(GridView tablo, string raporBaslik, string subeAdi, string kayitSekli = null, string kayitDurum = null, string iptalDurumu = null, string p1Baslik = null, string p1Value = null, string p2Baslik = null, string p2Value = null)
        {
        ...
        private static void Link_CreateMarginalHeaderArea(object sender, CreateAreaEventArgs e)
        {
            ...
            if (_iptalDurumu != null)
            {
                ...
                _ps.Graph.DrawBrick(baslikBrick, new RectangleF(250, 55, 70, 15));
