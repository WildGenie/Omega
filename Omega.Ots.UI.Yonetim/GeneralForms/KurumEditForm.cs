...
using Omega.Ots.UI.Yonetim.Forms.BaseForms;
...
namespace Omega.Ots.UI.Yonetim.GeneralForms
{
    public partial class KurumEditForm : BaseEditForm
    {
        ...
        protected override bool EntityInsert()
        {
            ...
            Functions.YonetimGeneralFunctions.CreateConnectionString("OmegaOtsYonetim", txtServer.Text, txtKullaniciAdi.Text.ConvertToSecureString(), txtSifre.Text.ConvertToSecureString(), txtYetkilendirmeTuru.Text.GetEnum<YetkilendirmeTuru>());
